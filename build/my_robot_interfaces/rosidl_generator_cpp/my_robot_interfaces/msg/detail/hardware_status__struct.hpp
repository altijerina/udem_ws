...
struct HardwareStatus_
{
  ...
  using _are_models_ready_type =
    bool;
  _are_models_ready_type are_models_ready;
  ...
  Type & set__are_models_ready(
    const bool & _arg)
  {
    this->are_models_ready = _arg;
    return *this;
  }
  ...
  bool operator==(const HardwareStatus_ & other) const
  {
    ...
    if (this->are_models_ready != other.are_models_ready) {
      return false;
    }
