  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: are_models_ready
  {
    cdr << (ros_message->are_models_ready ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: are_models_ready
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->are_models_ready = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name are_models_ready
  {
    size_t item_size = sizeof(ros_message->are_models_ready);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name debug_message
