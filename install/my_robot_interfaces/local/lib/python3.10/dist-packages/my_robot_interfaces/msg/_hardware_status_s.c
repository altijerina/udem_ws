...
bool my_robot_interfaces__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // are_models_ready
    PyObject * field = PyObject_GetAttrString(_pymsg, "are_models_ready");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->are_models_ready = (Py_True == field);
    Py_DECREF(field);
  }
  {  // debug_message
...
PyObject * my_robot_interfaces__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // are_models_ready
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->are_models_ready ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "are_models_ready", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
