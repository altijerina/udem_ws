...
class HardwareStatus(metaclass=Metaclass_HardwareStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.are_models_ready = kwargs.get('are_models_ready', bool())
    ...
    def __eq__(self, other):
        ...
        if self.temperature != other.temperature:
            return False
        if self.are_models_ready != other.are_models_ready:
            return False
    ...
    def are_models_ready(self):
        """Message field 'are_models_ready'."""
        return self._are_models_ready

    @are_models_ready.setter
    def are_models_ready(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'are_models_ready' field must be of type 'bool'"
        self._are_models_ready = value
