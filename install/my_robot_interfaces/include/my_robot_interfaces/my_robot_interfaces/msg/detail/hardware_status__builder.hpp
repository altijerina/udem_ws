...
class Init_HardwareStatus_are_models_ready
{
public:
  explicit Init_HardwareStatus_are_models_ready(::my_robot_interfaces::msg::HardwareStatus & msg)
  : msg_(msg)
  {}
  Init_HardwareStatus_debug_message are_models_ready(::my_robot_interfaces::msg::HardwareStatus::_are_models_ready_type arg)
  {
    msg_.are_models_ready = std::move(arg);
...
public:
  ...
  {}
  Init_HardwareStatus_are_models_ready temperature(::my_robot_interfaces::msg::HardwareStatus::_temperature_type arg)
  {
    msg_.temperature = std::move(arg);
    return Init_HardwareStatus_are_models_ready(msg_);
  }
